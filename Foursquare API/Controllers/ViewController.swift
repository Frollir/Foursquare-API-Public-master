...
class ViewController: UIViewController {
    ...
    func loadData() {
        ...
        urlComponents.queryItems = [
            URLQueryItem(name: "client_id", value: "U34GZW25B2ZJ5BPYHOWSYBFHI1XZFEV30EHLAADCFKM1REWF"),
            URLQueryItem(name: "client_secret", value: "RUF2RIAEG2ORYHPTORDHBMRL0OKNJQKTC3QMG5TM3SESR0AH"),
...
extension ViewController {
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        guard let controller = segue.destination as? VenueTableViewController else
            { return }
